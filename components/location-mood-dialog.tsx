...
export function LocationMoodDialog({ open, onOpenChange }: LocationMoodDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-4xl mx-auto max-h-[90vh] overflow-y-auto bg-white dark:bg-black border-gray-200 dark:border-gray-800 text-black dark:text-white">
        ...
        <Tabs defaultValue="analysis" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-gray-100 dark:bg-gray-900">
            <TabsTrigger
              value="analysis"
              className="flex items-center gap-2 data-[state=active]:bg-white dark:data-[state=active]:bg-gray-800 text-black dark:text-white"
            >
            ...
            {selectedLocation ? (
              <div className="space-y-4">
                <div className="flex items-center gap-2 pb-2 border-b border-gray-200 dark:border-gray-800">
                  ...
                  <h3 className="font-semibold text-black dark:text-white">Entries from {selectedLocation}</h3>
                  <span className="text-sm text-gray-500 dark:text-gray-500">({locationEntries.length} entries)</span>
                </div>
                ...
                {isLoadingEntries ? (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500 dark:text-gray-500">No entries found for this location.</p>
                  </div>
                ) : (
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {locationEntries.map((entry) => (
                      <div
                        ...
                        className="p-4 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 bg-white dark:bg-gray-950"
                      >
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 dark:text-gray-500">
                  Select a location from the Analysis tab to view entries.
                </p>
              </div>
            )}
          </TabsContent>

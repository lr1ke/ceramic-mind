      ...
      <DialogContent className="w-[95vw] max-w-2xl mx-auto max-h-[90vh] overflow-y-auto">
        ...
        {!analysis && !isAnalyzing && (
          <div className="space-y-4">
            ...
            <Button onClick={handleAnalyze} className="w-full bg-indigo-600 hover:bg-indigo-700">
        ...
        {isAnalyzing && (
          <div className="flex flex-col items-center justify-center py-8 space-y-4">
            ...
            <p className="text-gray-600">Analyzing your entries...</p>
          </div>
        )}
        ...
        {analysis && (
          <div className="space-y-4">
            <Card>
              ...
              <CardContent>
                <Badge className="text-lg px-3 py-1">{analysis.overallMood}</Badge>
              </CardContent>
            </Card>
